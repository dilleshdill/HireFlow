...
const OnlineTestExam = () => {
  ...
  <div className="pt-6 flex flex-col gap-5">
    <div className="flex justify-between items-center">
        <button className="bg-purple-900 text-white px-5 py-2 rounded-3xl" onClick={getPreview}>
        Mark As Preview
    </button>
    <div className="flex gap-4">
        <button className="bg-gray-400 px-5 py-2 rounded-3xl text-white" onClick={getPrevious}>
            Previous
        </button>
        <button className="flex items-center bg-cyan-600 px-5 py-2 rounded-3xl text-white" onClick={getNext}>
            Next
            <ArrowRight />
        </button>
    </div>
      ...
      <div className="w-full lg:w-1/3 ">
        ...
        <div className="flex items-center gap-8 justify-center mt-5">
            <div className="flex flex-col gap-2 items-center">
                <p className="text-3xl font-normal font-mono text-gray-500">{String(hours).padStart(2,"0")}</p>
                <p className="text-xl font-normal text-gray-400">hours</p>
            </div>
            <div className="flex flex-col gap-2 items-center">
                <p className="text-3xl font-normal font-mono text-gray-500">{String(minutes).padStart(2,"0")}</p>
                <p className="text-xl font-normal text-gray-400">minutes</p>
            </div>
            <div className="flex flex-col gap-2 items-center">
                <p className="text-3xl font-normal font-mono text-gray-500">{String(seconds).padStart(2,"0")}</p>
        ...
        <div className="cursor-pointer flex flex-wrap px-15 py-5 gap-3  justify-center">
            {
                questions.map((eachQuestion,index) => (
                    <div className="flex h-10 w-10 border border-gray-400 text-gray-500 items-center justify-center rounded-lg" onClick={()=>setCurrentIndex(index)}>
                        {index+1}
                    </div>
        ...
        <div className="flex items-center gap-1">
            <FaRegDotCircle className="text-gray-500 fill-gray-600" size={20}/>
            <p className="text-gray-600 text-md">Not Seen</p>
        </div>
        <div className="flex items-center gap-1">
            <FaRegDotCircle className="text-green-500 fill-green-600" size={20}/>
            <p className="text-gray-600 text-md">Attempted</p>
        </div>
        <div className="flex items-center gap-1">
            <FaRegDotCircle className="text-blue-500 fill-blue-600" size={20}/>
            <p className="text-gray-600 text-md">current</p>
        </div>
        <div className="flex items-center gap-1">
            <FaRegDotCircle className="text-purple-500 fill-purple-600" size={20}/>
