...
import { MoveRight, UserRoundPen, CloudUpload,Link,Facebook,Twitter,Youtube,Instagram,Mail} from 'lucide-react';
    ...
    <div className='w-full bg-white py-5'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='flex justify-between items-center'>
          <h1 className='text-2xl font-bold py-4'>HireFlow</h1>

          {/* Setup progress */}
          <div className='flex flex-col gap-1'>
            <div className='flex justify-between'>
                <p className='text-gray-400 text-sm'>Setup Progress</p>
                <p className='text-blue-500 text-sm font-bold'>{(progress-1) * 25}%</p>
            </div>
        ...
        
        {
          ...
          <div className='flex max-w-3xl mx-auto justify-around gap-7'>
            ...
            <div className='flex flex-col items-center w-full'>
              <div className={`flex gap-1 items-center ${progress === 1 ? "text-blue-500 font-semibold" : "text-gray-400"}`}>
            ...
            {/* Step 2 */}
            <div className='flex flex-col items-center w-full'>
              <div className={`flex gap-1 items-center ${progress === 2 ? "text-blue-500 font-semibold" : "text-gray-400"}`}>
                <UserRoundPen size={22} />
            ...
            {/* Step 3 */}
            <div className='flex flex-col items-center w-full'>
              <div className={`flex gap-1 items-center ${progress === 3 ? "text-blue-500 font-semibold" : "text-gray-400"}`}>
                <UserRoundPen size={22} />
            ...
            {/* Step 4 */}
            <div className='flex flex-col items-center w-full'>
              <div className={`flex gap-1 items-center ${progress === 4 ? "text-blue-500 font-semibold" : "text-gray-400"}`}>
                <UserRoundPen size={22} />
          ...
          <div className='mt-7 text-center max-w-5xl mx-auto '>
            ...
            {progress === 1 &&
              <div className='flex flex-col gap-3 w-full'>
                <h1 className='text-lg font-medium text-gray-700 text-start'>Logo & Banner Images</h1>
                ...
                <div className='flex gap-5 '>
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    <h1 className='text-md text-gray-600 text-start '>Banner Image</h1>
                    <div className='bg-gray-100 rounded-md h-48 flex flex-col flex-1 items-center justify-center cursor-pointer hover:bg-gray-50 transition'>
                      <CloudUpload size={30} className='text-gray-400' />
                      <p className='text-gray-500'><span className='text-black'>Browse Photo</span> or Drop here</p>
                      <p className='text-gray-400 w-96'>A Banner images optical dimension 1200*1700 is supported.
                        Formate Jpg,png. Max Photos size 5mg
                      </p>
                    </div>
                  </div>
            ...
            {progress === 2 && 
                <div className='mt-7 text-center max-w-5xl mx-auto'>
                    <div className='grid gap-15 grid-cols-1 md:grid-cols-3 mt-10'>
                        <div className='flex flex-col gap-2'>
                            <h1 className='text-gray-500 text-lg text-start'>Organization Type</h1>
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='text-gray-500 text-lg text-start'>Industry Type</h1>
                            <select className='text-gray-400 border border-gray-300 p-3' placeholder="select">
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='text-gray-500 text-lg text-start'>Team Size</h1>
                            <select className='text-gray-400 border border-gray-300 p-3' placeholder="select">
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='text-gray-500 text-lg text-start'>Year of Establishment</h1>
                            <input
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='text-gray-500 text-lg text-start'>Company Website</h1>
        ...
        {
            isSubmit && 
            <div className="flex flex-col items-center justify-center-safe min-h-screen text-center space-y-4">
                ...
                <p className="text-gray-500 max-w-md">
                    Donec hendrerit, ante mattis pellentesque eleifend…
                </p>

                <div className="flex space-x-3">
                    <button className="px-5 py-2 rounded-md border text-blue-600 border-blue-200">
                    View Dashboard
                    </button>
