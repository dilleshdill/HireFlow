        ...
        <div className="flex-1 max-w-6xl p-4 overflow-y-auto h-[calc(100vh-64px)]">
            <div className="flex gap-3 justify-end">
                <div className="flex flex-col">
                    <button className="flex justify-end w-fit bg-gray-100 px-3 py-1 rounded-sm" onClick={()=>setFilter(!showFilter)}>
                        Filter
                    </button>
                    {
                        showFilter && 
                        <div className="flex flex-col w-fit px-4 py-3 bg-white justify-self-end shadow-2xl rounded-lg gap-3">
                            <h1 className="text-gray-500 text-md font-semibold">Filter Applications</h1>
                            ...
                            <label className="flex items-center gap-2 cursor-pointer">
                                ...
                                defaultChecked
                                />
                                <span className="text-gray-700">All Applications</span>
                            </label>
                ...
                <div className="flex flex-col">
                    <button className="flex bg-blue-700 px-4 py-1 text-white rounded-sm">
                        Sort
                    </button>
                </div>
            </div>
