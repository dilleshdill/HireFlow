const Footer = () => {
    return (
        <>
            ...
            <footer className="flex flex-wrap mt-10 justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-black">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <p className="text-slate-100 font-bold text-lg">HireFlow</p>
                    <div>
