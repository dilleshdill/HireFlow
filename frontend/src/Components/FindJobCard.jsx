...
const FindJobCard = () => {
  ...
  useEffect(() => {
    ...
    const fetchFavoriteJobs = async () => {
      try {
        const response = await axios.get(DOMAIN + "/api/job/get-favorite", {
          withCredentials: true,
        });
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="w-full bg-white grid grid-cols-1 sm:grid-cols-5 gap-3 p-4 rounded-sm shadow-sm">
            ...
            <div
              ...
              className="flex items-center justify-between px-4 border border-gray-200 gap-1 text-sm text-gray-600 cursor-pointer"
            >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {jobFilterData.experience.map((item) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          experience === item.value ? "text-[#0A65CC]" : ""
                        }
                      >
                        {item.label}
                      </span>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {jobFilterData.jobType.map((item) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          jobType.includes(item.value) ? "text-[#0A65CC]" : ""
                        }
                      >
                        {" "}
                        {item.label}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {jobFilterData.education.map((item) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          education.includes(item.value) ? "text-[#0A65CC]" : ""
                        }
                      >
                        {" "}
                        {item.label}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {jobFilterData.jobLevel.map((item) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          jobLevel === item.value ? "text-[#0A65CC]" : ""
                        }
                      >
                        {item.label}
                      </span>
