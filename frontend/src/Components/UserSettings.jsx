              ...
              <div className="mt-7 text-center max-w-5xl mx-auto">
                <div className="grid gap-5 grid-cols-1 md:grid-cols-2 mt-10">
                  <div className="flex flex-col gap-2">
                    ...
                    value={userProfileData.nationalitie}
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                      className="text-gray-400 border border-gray-300 p-3"
                      placeholder="select"
                      value={userProfileData.martinalStatus}
                        onChange={(e) => setUserProfileData({...userProfileData,martinalStatus:e.target.value})}
                    >
                      <option disabled selected value="">
                        Select
                      </option>
                ...
                <div className="flex flex-col mt-10 gap-2">
                  ...
                  <textarea
                  onChange={(e) => setUserProfileData({...userProfileData,description:e.target.value})}
            ...
            <div className="bg-white w-full max-w-lg rounded-lg shadow-lg p-6">
              ...
              <div className="mb-6">
                ...
                </label>
                {
                    ...
                    : 
                    <div className="border-2 border-dashed border-gray-300 rounded-md p-6 text-center flex flex-col items-center" onClick={handleBoxClick}>
