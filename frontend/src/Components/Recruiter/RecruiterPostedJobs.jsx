  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between p-2">
        <p className="font-medium text-gray-700">My jobs ( {jobs.length} )</p>
      ...
      <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:hidden">
        {jobs.map((job) => (
          ...
          >
            <div onClick={()=>navigate(`/company-profile/${job._id}`)} className="flex cursor-pointer items-center gap-4 mb-4">
              <img
      ...
      <div className="hidden sm:flex lg:col-span-3 flex-col gap-4 pt-3">
        {jobs.map((job) => (
          ...
          >
            {/* LEFT */}
            <div onClick={()=>navigate(`/company-profile/${job._id}`)} className="flex cursor-pointer items-center gap-4">
              <img
